    ...
    return (
        <section className='bg-hfWhite sm:py-32 py-14'>
            <div className="flex flex-col justify-center items-center w-full">
                ...
                <div className="flex flex-col items-center justify-center text-center p-16 max-w-[90vw] bg-gradient-to-b from-orange-400 to-orange-500 rounded-2xl shadow-lg text-hfWhite relative z-20">
